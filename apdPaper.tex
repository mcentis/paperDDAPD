...
\begin{figure}
  \centering
  \subfloat{\includegraphics[width = 0.6 *0.6 \columnwidth, trim=0.3cm 0.3cm 0.2cm 0.3cm, clip]{APD_Diagram}}\\
  \subfloat{\includegraphics[width = 0.8 *0.6 \columnwidth]{apdSectionNew}}
