...
RMD 8x8mm 2 avalanche diode Gain vs. bias voltage response for 20 nsec(wide ?) 425nm led pulses.
Unity gain refers to the amplitude obtained at the ~500V bias where amplitude is roughly V independent. 
An attempt was made to parametrize regular trend in V required for a given gain vs. T by an ad hoc re-scaling of V’ = V-2.45*T( 0 C).
This parametrization of the pattern up to Gain~1000 may prove useful for discriminating among impact ionization models that appear in the literature and as options in ,eg SILVACO TM for modeling such devices.
...
\begin{figure}
  \centering
  \subfloat{\includegraphics[width = 0.6 \textwidth]{gainVsV}}
  \hfill
  \subfloat{\includegraphics[width = 0.4 \textwidth]{gainVsVscaled}}
  \caption{\textbf{Left:} \textbf{Right:} Gain Measurements of 8x8 mm RMD APDs measured w 430 nm laser pulses.}
  \label{fig:gainfig}
\end{figure}
