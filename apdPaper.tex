...
\begin{figure*}[h]
  \centering
  \subfloat{\includegraphics[width = 0.53 \textwidth]{gainVsV}}
  \hfill
  \subfloat{\includegraphics[width = 0.47 \textwidth]{gainVsVscaled}}
...
\begin{figure}
  \centering
  \includegraphics[width = \columnwidth]{IVnIrrad}
...
\begin{figure}
  \centering
  \includegraphics[width = \columnwidth]{ampliIrrad_5mV}
...
The AC-coupled mesh readout of $8 \times 8$\,mm$^2$ APDs resulted in an improved uniformity of response, that was studied using a high energy muon beam.
...
The rise time, signal amplitude, and time of arrival are found to be independent of the impact position of the particles on the sensor.
...
%% The mesh readout development has several potential advantages, some of which were demonstrated by the above measurements.
%% Because the mesh readout results in a low impedance path for capturing the induced signal from charge motion within the silicon, it provides a very uniform signal shape (rise time) independent of impact position.
%% Also the effective detector capacitance seen by the amplifier is reduced in the mesh readout enabling development of fast low noise signal procesing front end, which will be discussed elsewhere.
