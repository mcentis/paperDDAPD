...
\author[uprinc]{\textcolor{red}{B.~Harrop}}
\author[uprinc]{\textcolor{red}{C.~Lu}}
...
This value of pile-up presents a challenge for the experiments, as currently ATLAS and CMS have reached a typical number of concurring interaction within the same bunch crossing (pile-up) of approximately 35\,\cite{atlasPileup,cmsPileup}.
...
This strategy was used also at Tevatron, where the pile-up was $\approx 6$ \textcolor{red}{ref?}.
