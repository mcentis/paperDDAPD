...
\begin{figure*}[h]
  \centering
  \subfloat{\includegraphics[angle = -90, width = 0.51 \textwidth]{gainVsV}}
  \hfill
  \subfloat{\includegraphics[width = 0.49 \textwidth]{gainVsVscaled}}
...
\begin{figure*}[h]
  \centering
  \subfloat[$\Phi_{eq} = 0$\,cm$^{-2}$, 1700\,V]{\includegraphics[width = 0.45 \textwidth]{APD_2B_3_APD_2B_3_maps_UNIRRAD_ROOT6_peak_signal_map_V1700V_IR_front}}\\
  \subfloat[$\Phi_{eq} = 3 \cdot 10^{13}$\,cm$^{-2}$, 1679\,V]{\includegraphics[width = 0.45 \textwidth]{APD_2B_3_APD_2B_3_maps_3E13_ROOT6_peak_signal_map_V1700V_IR_front}}\hfill
  \subfloat[$\Phi_{eq} = 6 \cdot 10^{13}$\,cm$^{-2}$, 1673\,V]{\includegraphics[width = 0.45 \textwidth]{APD_2B_5_APD_2B_5_maps_6E13_ROOT6_peak_signal_map_V1700V_IR_front}}\\
  \subfloat[$\Phi_{eq} = 3 \cdot 10^{14}$\,cm$^{-2}$, 1677\,V]{\includegraphics[width = 0.45 \textwidth]{APD_2B_4_APD_2B_4_maps_3E14_ROOT6_peak_signal_map_V1700V_IR_front}}\hfill
  \subfloat[$\Phi_{eq} = 10^{15}$\,cm$^{-2}$, 1644\,V]{\includegraphics[width = 0.45 \textwidth]{APD_2B_9_APD_2B_9_maps_1E15_ROOT6_peak_signal_map_V1700V_IR_front}}
