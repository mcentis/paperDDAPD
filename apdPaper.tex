...
\begin{figure}
  ...
  \caption{\textbf{Left:} Gain measurement of $8 \times 8$ mm$^2$ APDs at different temperatures using a blue LED. \textbf{Right:} By shifting the bias for each curve according to the law described in the test, it is possible to superimpose all curves.}
  \label{fig:gainfig}
\end{figure}
