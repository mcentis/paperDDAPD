...
\begin{figure*}[h]
  \centering
  \subfloat{\includegraphics[width = 0.52 \textwidth]{gainVsV}}
  \hfill
  \subfloat{\includegraphics[width = 0.48 \textwidth]{gainVsVscaled}}
...
For these measurements, a fast transimpedance amplifier with roughly 10\,$\Omega$ effective input impedance was used\,\cite{whiteACES2014}.
...
\paragraph{Time resolution}
The time resolution measurements for AC-coupled mesh readout $8 \times 8$~mm$^2$ APDs were performed using a 140\,GeV proton  beam at the Fermilab test beam facility\,\cite{ftbfPage}.
...
The setup consisted of an MCP-PMT\footnote{Micro Channel Plate Photomultiplier. \textcolor{red}{MODEL??}} used as trigger and time reference, and the APD.
...
As a phase difference of about 50\,ps is present between the differential signals, their combination effectively improved the sampling of the APD signal.
The events with an amplitude larger than 40\,mV were used in the analysis, while the MIP peak was 55\,mV.
To reduce the influence of the noise on the APD signal, a digital filter with a bandwidth of 500\,MHz was applied to the signal.
...
\begin{figure}
  ...
  \caption{Distribution of the time difference between the MCP-PMT trigger signal and the mesh APD. The distribution is described using the sum of a Gauss function with a constant offset. The measurement was performed using 140\,GeV protons. The APD was operated at 1800\,V (colour online).}
  \label{fig:dtDistrTB}
\end{figure}
...
\textcolor{red}{
  ...
  Using a proton beam that fully illuminated the active area of the detector, a time resolution of about 27\,ps was measured for a 1800\,V bias.
}
